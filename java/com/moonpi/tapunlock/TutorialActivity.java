...
public class TutorialActivity extends Activity implements View.OnClickListener {
    ...
    //layout items
    private TextView moonPiBrand, welcomeTo, tapunlock, appDescription, navigation, screenshotDescription;
    private ImageButton navRight, navLeft;
    private Button skip;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        moonPiBrand = (TextView)findViewById(R.id.moonPiBrand);
